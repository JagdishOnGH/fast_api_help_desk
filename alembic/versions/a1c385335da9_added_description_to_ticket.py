"""added description to ticket

Revision ID: a1c385335da9
Revises: 370e595883be
Create Date: 2025-08-30 19:48:58.320889
...
revision: str = 'a1c385335da9'
down_revision: Union[str, Sequence[str], None] = '370e595883be'
...
def downgrade() -> None:
    ...
    sa.ForeignKeyConstraint(['agent_id'], ['users.id'], name='tickets_agent_id_fkey'),
    sa.ForeignKeyConstraint(['category_id'], ['categories.id'], name='tickets_category_id_fkey'),
    sa.ForeignKeyConstraint(['subcategory_id'], ['subcategories.id'], name='tickets_subcategory_id_fkey'),
    sa.ForeignKeyConstraint(['user_id'], ['users.id'], name='tickets_user_id_fkey'),
    sa.PrimaryKeyConstraint('id', name='tickets_pkey'),
    sa.UniqueConstraint('ticket_uid', name='tickets_ticket_uid_key', postgresql_include=[], postgresql_nulls_not_distinct=False),
    postgresql_ignore_search_path=False
    )
    ...
    sa.Column('created_at', postgresql.TIMESTAMP(), server_default=sa.text('now()'), autoincrement=False, nullable=True),
    sa.ForeignKeyConstraint(['agent_id'], ['users.id'], name=op.f('ticket_notes_agent_id_fkey')),
    sa.ForeignKeyConstraint(['ticket_id'], ['tickets.id'], name=op.f('ticket_notes_ticket_id_fkey'), ondelete='CASCADE'),
