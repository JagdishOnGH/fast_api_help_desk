...
Revision ID: f1c7641eba41
Revises: a1c385335da9
Create Date: 2025-08-30 21:02:01.910310
...
revision: str = 'f1c7641eba41'
down_revision: Union[str, Sequence[str], None] = 'a1c385335da9'
...
def upgrade() -> None:
    ...
    op.execute("ALTER TYPE ticketstatus ADD VALUE IF NOT EXISTS 'req_reopen';")
