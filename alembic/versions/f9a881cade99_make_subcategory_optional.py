...
Revision ID: f9a881cade99
Revises: fa288f5505ae
Create Date: 2025-08-28 21:22:45.244185
...
revision: str = 'f9a881cade99'
down_revision: Union[str, Sequence[str], None] = 'fa288f5505ae'
...
def downgrade() -> None:
    ...
    sa.Column('name', sa.VARCHAR(length=100), autoincrement=False, nullable=False),
    sa.Column('description', sa.TEXT(), autoincrement=False, nullable=True),
    sa.ForeignKeyConstraint(['category_id'], ['categories.id'], name=op.f('subcategories_category_id_fkey'), ondelete='CASCADE'),
